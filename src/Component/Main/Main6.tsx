           ...
           <div className='facilities'>
               <div className='facility f1'>
                  ...
                  <div className='imagep'>
                    <img src="/images/car.png"  alt="amneities"/>
                  </div>     
                 ...
                 <div className="g tv">
                  <div className='imagep'>
                  <img src="/images/screen.png" alt="amneities"/></div>
                  <div className='person m'>TV</div>
                 </div>
        
                 <div className="g both work">
                  <div className='imagep'><img src="/images/web.png" alt="amneities"/></div>
              ...
              <div className='facility f2'>
                 ...
                 <div className="g free">
                 <div className='imagep'>
                   <img src="/images/para.png" alt="amneities"/>
                 </div>     
                ...
                <div className="g tv">
                 <div className='imagep'>
                 <img src="/images/wifi.svg" alt="wifi"/></div>
                 <div className='person m'>WIFI</div>
                </div>
        
                <div className="g both work">
                 <div className='imagep'><img src="/images/wash.svg" alt="amneities"/></div>
             ...
             <div className='facility f3'>
                ...
                <div className="g tv">
                 <div className='imagep'>
                 <img src="/images/wifi.svg" alt="amneities"/></div>
