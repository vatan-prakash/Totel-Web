  ...
  return (
    <div className="">
      ...
      <div style={{ marginTop: "9rem" }}>
        <Link href="/">
          <button className="px-6 py-2 mb-4 ml-5 lg:ml-20 text-black transition-colors duration-300 bg-white border rounded-full border-grey hover:bg-black hover:text-white hover:border-transparent">
            Back
          </button>
        </Link>
        <Container>
          <div className="flex flex-row items-center gap-3 p-4 rounded-full cursor-pointer md:py-1 md:px-2">
            ...
            <button className="px-6 py-2 ml-5 lg:ml-20 text-xs text-black transition-colors duration-300 bg-white border rounded-full border-grey hover:bg-black hover:text-white hover:border-transparent">
              Follow
            </button>
          </div>
        </Container>
        <div>
          <div className="flex items-center justify-center gap-2 m-10 flex-col lg:flex-row">
            <div className="gap-2">
              <Image
