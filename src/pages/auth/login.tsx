  ...
  return (
    <>
      <div className={styles.container}>
        <div className="flex flex-col lg:flex-row justify-center  p-0 w-1512 h-1117.09 ">
          ...
          <div className={styles.card}>
            <div className="flex flex-col justify-center bg-gray-100 sm:px-6 lg:px-8 w-full">
